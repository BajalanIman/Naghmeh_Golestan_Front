      ...
      <div className="w-full lg:w-1/2 bg-[#ECEAD3] h-full px-10 py-12 lg:pb-0">
        <div className="flex gap-6 ">
          <div className="flex flex-col">
            ...
            <h1 className="text-4xl font-bold text-violet-900">Subscription</h1>
          </div>
          <Send className="text-violet-900 w-20 h-20" />
        </div>
        <div className="text-violet-900 text-2xl flex flex-col gap-2 mt-12 mb-12">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-[11px] pl-8 text-violet-900">
            and accept the privacy policy.
          </span>
          <div className="text-white flex flex-row bg-violet-900 rounded-lg justify-center items-center gap-3 w-28 h-14 mt-8">
            <p>Send</p>
