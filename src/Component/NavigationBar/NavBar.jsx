...
const NavBar = () => {
  ...
  return (
    <div className="flex  py-12 px-2 lg:px-0 relative justify-between bg-black bg-opacity-0 ">
      <div className="flex justify-between gap-8">
        ...
        <Link
          className="font-bold cursor-pointer from-neutral-800 pt-2 text-[#F8D41B] hover:text-yellow-200"
          to="/workshops"
        >
          Workshops
        </Link>
        <h1 className="font-bold cursor-pointer from-neutral-800 pt-2 text-[#F8D41B] hover:text-yellow-200">
          Courses
        </h1>
        <h1 className="font-bold cursor-pointer from-neutral-800 pt-2 text-[#F8D41B] hover:text-yellow-200">
          News
      ...
      <div className="flex gap-8">
        <div className="flex gap-2s">
          <span className="font-bold cursor-pointer from-neutral-800 pt-2 pr-1 text-[#F8D41B] hover:text-yellow-200">
            EN |
          </span>
          <span className="font-bold cursor-pointer from-neutral-800 pt-2 pr-1  text-[#F8D41B] hover:text-yellow-200">
            DE |
          </span>
          <span className="font-bold cursor-pointer from-neutral-800 pt-2 text-[#F8D41B] hover:text-yellow-200">
            FR
          </span>
        </div>
        <div className="flex gap-5">
          ...
          {!localUser ? (
            <Link
              to="/login"
              className="bg-[#F8D41B] w-20 h-10 pt-1 pl-4 border rounded-md text-cyan-900 hover:bg-yellow-200"
            >
              Login
            </Link>
          ) : (
